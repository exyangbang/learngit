...
import cn.kingnet.utp.scheduler.data.entity.vo.TransHistoryVo;
...
@TableName("t_trans_history")
@NoArgsConstructor
@AllArgsConstructor
@Data
@Builder
@MapperInterface("cn.kingnet.utp.scheduler.data.mapper.TransHistoryMapper")
