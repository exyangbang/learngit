...
import cn.kingnet.utp.scheduler.data.entity.vo.TransCurrentVo;
...
@TableName("t_trans_current")
@NoArgsConstructor
@AllArgsConstructor
@Data
@Builder
@MapperInterface("cn.kingnet.utp.scheduler.data.mapper.TransCurrentMapper")
public class TransCurrent extends BaseEntity {
    /**
     * 主键
     */
