...
import cn.kingnet.utp.service.persistence.entity.vo.IndustryVo;
...
@Data
@Builder
@MapperInterface("cn.kingnet.utp.service.persistence.mapper.IndustryMapper")
public class Industry extends BaseEntity {
     ...
     */
    @TableField(value = "open_account_mode")
    private Integer openAccountMode;

    /**
     * 0=“根据来款账户上账”、1=“无限制的来款上账”
     */
    @TableField(value = "industry_income_type")
    private Integer industryIncomeType;

    /**
     * 是否支持自定义显示付款账号及户名 0否 1是
     */
    @TableField(value = "open_show_custom_flag")
