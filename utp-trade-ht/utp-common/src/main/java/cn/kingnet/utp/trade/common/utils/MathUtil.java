...
public class MathUtil {
     ...
     * @param a     被加数
     * @param b     加数
     * @param scale 小数点后保留几位, 默认保留2位小数点
     * @return 四舍五入后的结果
     * @author jqlin
     */
     ...
     * @param a     被除数
     * @param b     除数
     * @param scale 保留小数点后多少位, 默认保留2位小数点
     * @return 四舍五入后的结果
     * @author jqlin
     */
    ...
    /**
     *  分转元并四舍五入后保留2位数.金额小于0的 返回 0
     * @param amount 单位分
     * @return
     */
    public static String formatAmt(long amount) {
        if(amount<0)return "0";
        return new BigDecimal(amount).divide(new BigDecimal(100L), 2, BigDecimal.ROUND_HALF_UP).toString();
    }
