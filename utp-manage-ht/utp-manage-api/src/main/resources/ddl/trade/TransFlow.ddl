...
create table t_trans_current (
	...
	,acc_no varchar(50)  COMMENT '企业入网时分配的企业编码'
) COMMENT '当天交易流水表';
...
create  index t_trans_history_index_1 on t_trans_history(mer_no);
create  index t_trans_history_index_2 on t_trans_history(channel_code);
create  index t_trans_history_index_3 on t_trans_history(org_code);