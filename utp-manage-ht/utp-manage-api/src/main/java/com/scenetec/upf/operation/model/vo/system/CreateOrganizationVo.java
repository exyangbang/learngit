...
@ApiModel("机构信息")
@Data
public class CreateOrganizationVo implements Serializable {
    ...
    @Size(min=1,max = 200,message = "机构名称最大长度不能超过200")
    private String fullName;

    /**机构简称*/
    @ApiModelProperty(value = "机构简称")
    @Size(min=1,max = 200,message = "机构简称最大长度不能超过200位")
    private String simpleName;

    /**机构代码*/
    @ApiModelProperty(value = "机构代码")
    @NotNull(message = "机构代码不能为空")
    @Size(min=1,max = 12,message = "机构代码最大长度不能超过12位")
    private String orgCode;

    /**联系人姓名*/
    @ApiModelProperty(value = "业务联系人姓名")
    @NotNull(message = "业务联系人姓名不能为空")
    @Size(min=1,max = 20,message = "业务联系人姓名最大长度不能超过20位")
    private String contactName;

    /**联系人电话*/
    @ApiModelProperty(value = "业务联系人电话")
    @NotNull(message = "业务联系人电话不能为空")
    @Size(min=1,max = 20,message = "业务联系人电话不能超过20位")
    private String contactTel;

    /**联系人邮箱*/
    @ApiModelProperty(value = "业务联系人邮箱")
    @NotNull(message = "业务联系人邮箱不能为空")
    @Size(min=1,max = 50,message = "业务联系人邮箱最大长度不能超过50位")
    private String contactEmail;

    /**联系人地址*/
    @ApiModelProperty(value = "业务联系人地址")
    @Size(min=1,max = 200,message = "业务联系人地址最大长度不能超过200位")
    ...
    @Size(min=1,max = 20,message = "法人姓名最大长度不能超过20位")
    private String legalName;

    /**法人身份证号*/
    @ApiModelProperty(value = "法人身份证号")
    @NotNull(message = "法人身份证号不能为空")
    @Size(min=1,max = 18,message = "法人身份证号最大长度不能超过18位")
    ...
    @Size(min=1,max = 18,message = "营业执照号码最大长度不能超过18位")
