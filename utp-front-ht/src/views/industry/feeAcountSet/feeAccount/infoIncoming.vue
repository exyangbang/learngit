            ...
            <Col>
                <Form ref="form" :model="formData" label-position="right" :inline="true">
                    ...
                    <FormItem :label-width="0">
                      ...
                      <!--<Button type="success" style="position: relative; left: -100px" @click="createBtn()" v-access id="addIndustryFeeAccount">新增账户</Button>-->
                    </FormItem>
                </Form>
            </Col>
        </Row>
...
<script>export default {
  ...
  methods: {
    ...
    searchList (param) {
      ...
      param.parameters = {}
      param.parameters.industryType = localStorage.getItem('industryType')
      param.parameters.industryCode = localStorage.getItem('industryCodeComing')
