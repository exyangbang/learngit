...
<template>
  <card>
      ...
      <Col>
        <Form border :label-width="120" ref="form" :model="formData" label-position="right" :inline="true">
          <FormItem label="证书名称：" prop="certificateName">
            <Input v-model="formData.certificateName" class="input-width-170" :maxlength="nameSize"/>
          </FormItem>
          <FormItem label="商户号：" prop="merNo">
            <Input v-model="formData.merNo" class="input-width-170" :maxlength="accountSize" />
          </FormItem>
          <FormItem>
            <Button type="primary" v-access id="channelListCertificateInfo" @click="searchBtn()">查询</Button>
            <Button html-type="reset" class="margin-left-10 " @click="resetBtn()">重置</Button>
            <Button type="success" v-access id="channelAddCertificateInfo" class="margin-left-10"  @click="showCreate()">添加</Button>
          </FormItem>
        </Form>
      </Col>
    </Row>
    ...
    <!-- 弹出商户选择框-->
    <Modal v-model="funcModal" title="选择关联商户" width="700" :mask-closable="false">
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', [
              ...
              // h('Button', {
              //   attrs: {
              //     id: 'channelDetailCertificateInfo'
              //   },
              //   directives: [{
              //     name: 'access'
              //   }],
              ...
              h('Poptip', {
                ...
                h('svg-icon', {
                  attrs: {
                    id: 'channelDeleteCertificateInfo',
                    title: '删除'
                  },
                  directives: [{
                    name: 'access'
