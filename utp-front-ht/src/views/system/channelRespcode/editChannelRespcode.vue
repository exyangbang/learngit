          ...
          <row>
            <Col span="12">
              <FormItem label="启用状态：" prop="status">
                <Select v-model="formData.status" style="width: 300px" @on-change="chanStatus">
...
export default {
  ...
  activated () {
    let initParamVal = this.$util.getRefreshInitParam(this, 'editChannelRespcode', this.$route.params.id)
